...
The rest of the paper proceeds as follows. In Section \ref{conceptual-underpinnings}, we review the theoretical structure of migration decisions, in Section \ref{data} discuss our data sources, in Section \ref{methods} present our estimating equations, and in Section \ref{results} present our results.
